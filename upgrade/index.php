...
=====================================================
 Evetнный код защищен Yazarскими правами
=====================================================
 Файл: index.php
-----------------------------------------------------
...
if ( strtolower($config['charset']) != $distr_charset ) {
	msgbox("info", "Bilgilendirme", "Sitenizin kodlaması ile dağıtımın kodlaması uyuşmuyor. Sitenizin kodlaması: <b>{$config['charset']}</b>, güncelleme yapabilmeniz için kodlamanızın bu olması gerekmektedir: <b>{$distr_charset}</b>. Güncelleme yapabilmek için uygun kodlamalı sürümü indirmelisiniz.");
	die();
}
